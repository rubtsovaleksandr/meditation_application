//
//  ChooseTopicViewCell.swift
//  Meditation
//
//  Created by Aleksandr on 22/11/2020.
//  Copyright © 2020 Aleksandr. All rights reserved.
//

import UIKit

class ChooseTopicViewCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        imageObject.bottomAnchor.constraint(equalTo: contentView.bottomAnchor, constant: 0).isActive = true
